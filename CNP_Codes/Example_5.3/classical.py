...
def pdas_gamma_moreau_yosida(A, yd, psi, beta, gamma, lam_bar, y0, maxit=80):
    """
    Correct scaling:
...
def plot_surface(ax, X1, X2, Z, title, cmap="viridis"):
...
def solve_problem1_and_plot_3d(h=1/128, gamma=1e8, beta=0.1):
    ...
    plot_surface(ax1, X1, X2, Y, "State y_h", cmap="viridis")
    plot_surface(ax2, X1, X2, U, "Control u_h", cmap="coolwarm")
    plot_surface(ax3, X1, X2, Lam, "Multiplier λ_h", cmap="plasma")
